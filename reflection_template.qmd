...
# PA 4
# I used a practice activity because we didn't read in an xlsx file in any of our labs
...
# Lab 3, Q5
# I modified my code to remove several unnecessary variables using select(-c())
# This allowed me to efficiently drop columns at once
# As a result, my output gave me my desired variables
...
# I also added starts_with(), which selects the variables that start with mc (e.g. mc_infant, mc_toddler, mc_preschool) and deleted these variables from my select, as it was redundant
...
# Lab 5, No Interviews
# I used an anti-join to find people who do NOT have an interview transcript
# This keeps all rows from 'person' whose id does not appear in 'interview'
# This allows us to identify which individuals do not have to be interviewed

no_interviews <- person |> 
  anti_join(interview,
          by = join_by(id == person_id)
          ) 
no_interviews
...
# Lab 8, Q4
# I added an input check to ensure that aesthetic values were either 'fill' or 'color'
...
# Lab 10, Q3
# I added geom_text to add text percentages on top of each bar so the reader can clearly interpret the percentages
...
# Lab 10, Q13
# I used geom_errorbar() to represent my confidence intervals
...
# Lab 3, Q8
# I used a filter(if_any()) to find missing values
...
# Lab 10, Q3
# I deleted my newly made object and instead made a new pipeline into ggplot()
...
# Challenge 3, Q3
# Chi-square Test
# I used a Chi-square test to check independence between SET level (evaluation rating of Q3: The professor used activities to make the class 
# more engaging) and instructor seniority level (years of experience)
...
# Lab 4, Q9
# Fitting a linear regression model to Median Household Income in 2018 
# and Childcare Costs for Infants
...
# Lab 2, Q17
# ANOVA 
# In this question I explored whether at least one rodent species 
# has a different population mean weight
